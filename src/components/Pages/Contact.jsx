...
function Contact() {
  ...
  const [data,setData] = useState([{name: "",product: "",msg: ""}])
  ...
  return (
    <div className="flex justify-center items-center flex-col mt-10 gap-10 px-4 ">
      ...
      className="w-full max-w-md  p-6 rounded-lg shadow-lg space-y-5">
        ...
        <button 
        type="submit"
        className="w-full bg-purple-500 text-white py-3 font-bold rounded hover:bg-purple-600 transition duration-300">
          Submit
        </button>
      </div>
    </div>
